          ...
          <tbody className="divide-y divide-gray-200">
            {pharmacies.length === 0 ? (
              ...
              pharmacies.map((pharmacy, index) => {
                const telegramBotDetails = getTelegramBotDetails(
                  (pharmacy as any).marketChats,
                );
                const hasTelegramBot =
                  (pharmacy as any).marketChats &&
                  Array.isArray((pharmacy as any).marketChats) &&
                  (pharmacy as any).marketChats.length > 0;
                  ...
                  >
                    ...
                    <td className="px-2 md:px-4 py-2 md:py-3 text-center">
                      <div className="space-y-1 flex flex-col items-center">
                        <div
                          className={`font-semibold text-xs px-2 py-1 rounded inline-block whitespace-nowrap ${
                            hasTelegramBot
                    ...
                    <td className="px-2 md:px-4 py-2 md:py-3 text-center">
                      <span
                        className={`px-2 py-1 rounded text-xs font-medium inline-block whitespace-nowrap ${
